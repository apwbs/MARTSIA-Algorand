...
if __name__ == "__main__":
    ...
    # print(id)
    # fund_program(id)
    authority1_private_key = 'qqjXhZOAFqFhVilPZo+fub9mGtFhSy+VL3rK2lvbFWTjp8WKdpjGZI5V3OCXwXaaZ+/HvZMMjcRFoI/xEhdKEA=='
    # create_box(id)
    # create_box(id)
    put_box(154287103, authority1_private_key, 'CIAO')
    # read_box(id)
    # length_box(id)
    # delete_box(id)
    # length_box(id)

...
def addApprovedAuthority(client: algod.AlgodClient, app_id: int, toApproveAddress: str):
    ...
    atc.add_method_call(
        app_id=app_id,
        method=get_method('approveAuthority', js),
        sender=sender,
        sp=sp,
        signer=signer,
...
def main():
    ...
    app_id=239796376
    addApprovedAuthority(algod_client, app_id, address)
